...
{   
    ...
    float c1=(_v[1].x()-_v[0].x())*(_v[0].y()-y-0.5)-(_v[1].y()-_v[0].y())*(_v[0].x()-x-0.5);//cross of product to determine if the point is within the triangle
    float c2=(_v[2].x()-_v[1].x())*(_v[1].y()-y-0.5)-(_v[2].y()-_v[1].y())*(_v[1].x()-x-0.5);
    float c3=(_v[0].x()-_v[2].x())*(_v[2].y()-y-0.5)-(_v[0].y()-_v[2].y())*(_v[2].x()-x-0.5);
