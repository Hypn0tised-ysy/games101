...
void rst::rasterizer::rasterize_triangle(const Triangle& t, const std::array<Eigen::Vector3f, 3>& view_pos) 
{
    ...
    y_min=(int)min3(t.v[0].y(),t.v[1].y(),t.v[2].y());
    y_max=(int)max3(t.v[0].y(),t.v[1].y(),t.v[2].y());
    ...
    //    * zp is depth between zNear and zFar, used for z-buffer
                ...
                depth_buf[index]=zp;
                //notice the set_pixel function is different than that in the Assignment2
                //this bug wastes me almost one day to figure out......
